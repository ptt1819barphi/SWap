 ...
 *
 * @author https://github.com/lintool
 * @contributor https://github.com/ptt1819barphi
 */
 ...
 */
public class WikiClean implements Serializable {
    ...
    private final boolean keepLinks;

    public WikiClean(boolean withFooter, boolean keepLinks) {
     ...
     *
     * @param content Wikipedia article
